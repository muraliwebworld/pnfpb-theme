<?php
/**
 * BuddyPress Activity Entry template override.
 *
 * Uses BP Nouveau template functions exclusively (no deprecated/removed stubs).
 * Follows buddyx's pattern: bp_nouveau_activity_entry_buttons() for the action
 * row and bp_nouveau_activity_comment_form() for inline replies.
 *
 * @package PNFPB_Theme
 */
